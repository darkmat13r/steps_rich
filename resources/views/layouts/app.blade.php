...
<head>
    ...
    <link href="{{asset('admin/css/pages/login/classic/login-5d1cf.css?v=7.1.6')}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset('admin/js/pages/custom/login/login-generald1cf.js?v=7.1.6')}}"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>

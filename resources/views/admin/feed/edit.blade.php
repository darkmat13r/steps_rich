    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <form action="{{route('feed.update',$data->id)}}" method="post" class="form" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PATCH') }}
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-12">
                                ...
                                <input type="file" name="url" value="{{old('url',$image->url)}}"
                                       class="form-control" accept="image/*">
                                <td><img src="{{$image->url}}" style="width:50px;"></td>
                            </div>
                            <div class="col-sm-12 col-12 mt-3">
                                <label content="">Content :<span class="text-danger">*</span></label>
                                <textarea type="text" name="content" rows="5"
                                          class="form-control mb-2" required>{{old('content',$data->content)}}</textarea>

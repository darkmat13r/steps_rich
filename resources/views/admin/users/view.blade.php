                            ...
                            <div class="d-flex flex-wrap justify-content-between mt-1">
                                <div class="d-flex flex-column flex-grow-1 pr-8">
                                    <div class="d-flex flex-wrap mb-4">
                                        ...
                                        <p class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <i class="fa fa-building text-primary mr-2"></i>Bank Name : {{($bankDetails)?$bankDetails->bank_name:''}}
                                        </p>
                                        <p class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <i class="fas fa-user text-primary mr-2 font-size-lg"></i>Acc. Name : {{($bankDetails)?$bankDetails->account_name:''}}
                                        </p>
                                ...
                                <div class="d-flex flex-column flex-grow-1 pr-8">
                                    <div class="d-flex flex-wrap mb-4">
                                        ...
                                        <p class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                            <i class="fas fa-table text-primary mr-2 font-size-lg"></i>Acc. No : {{($bankDetails)?$bankDetails->getRawOriginal('account_number'):''}}
                                        </p>
                                        <p class="text-dark-50 text-hover-primary font-weight-bold">
                                            <i class="fas fa-question text-primary mr-2 font-size-lg"></i>Acc. Type : {{($bankDetails)?$bankDetails->account_type:''}}
                                        </p>
                                    </div>
                                </div>
                            </div>

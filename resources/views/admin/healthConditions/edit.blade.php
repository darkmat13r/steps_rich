...
@push('title','Edit Health Condition')
@push('headerscript')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Edit Health Condition</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <form action="{{route('health-conditions.update',$data->id)}}" method="post" class="form">
                    @csrf
                    {{ method_field('PATCH') }}
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                <input type="text" name="require_addition_info" value="{{old('require_addition_info',$data->require_addition_info)}}"
